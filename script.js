...
chips.forEach((chip) => {
  chip.addEventListener("click", () => {
    ...
    if (demoTitle) demoTitle.textContent = chip.dataset.scenarioTitle || "";
    if (demoSummary) demoSummary.textContent = chip.dataset.scenarioSummary || "";
    if (demoMeta) demoMeta.textContent = chip.dataset.scenarioMeta || "";
    if (demoDetail) demoDetail.textContent = chip.dataset.scenarioDetail || "";
  });
});
